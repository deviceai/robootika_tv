...
def movie1(channel):
    ...
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=1')
...
def movie2(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=2')
...
def movie4(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=4')
...
def movie5(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=5')
...
def movie6(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=6')
...
def movie7(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=7')
...
def movie8(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=8')
...
def movie9(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=9')
...
def movie10(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=10')
...
def movie11(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=11')
...
def movie12(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=12')
...
def movie13(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=13')
...
def movie14(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=14')
...
def movie15(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=15')
...
def movie16(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=16')
...
def movie17(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=17')
...
def movie18(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=18')
...
def movie19(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=19')
...
def movie20(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=20')
...
def movie21(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=21')
...
def movie22(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=22')
...
def movie23(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=23')
...
def movie24(channel):
    ...
    # Sending the data to thingspeak
    response = urllib2.urlopen('https://api.thingspeak.com/update?api_key=RFXZ62G9U5SQAUY0&field1=24')
...
try:
    ...
    GPIO.setup(24, GPIO.IN, pull_up_down=GPIO.PUD_DOWN) #Button 19
    GPIO.setup(26, GPIO.IN, pull_up_down=GPIO.PUD_DOWN) #Button 20
    ...
    while True:
        if not 'event' in locals():
            ...
            event = GPIO.add_event_detect(24, GPIO.RISING, callback=movie19, bouncetime=200)
            event = GPIO.add_event_detect(26, GPIO.RISING, callback=movie20, bouncetime=200)
